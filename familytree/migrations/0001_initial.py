# Generated by Django 4.2.20 on 2025-04-19 11:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='partners', to='familytree.person')),
            ],
        ),
        migrations.CreateModel(
            name='FamilyTree',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation_type', models.CharField(choices=[('parent', 'Parent'), ('step-parent', 'Step Parent'), ('foster-parent', 'Foster Parent'), ('child', 'Child'), ('step-child', 'Step Child'), ('foster-child', 'Foster Child'), ('sibling', 'Sibling'), ('half-sibling', 'Half Sibling'), ('step-sibling', 'Step Sibling'), ('partner', 'Romantic Partner')], max_length=50)),
                ('from_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relations_from', to='familytree.person')),
                ('to_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relations_to', to='familytree.person')),
            ],
            options={
